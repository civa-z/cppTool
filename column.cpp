...
column_window::column_window(unsigned int column_num, float max_value, int width, int height, std::string window_name):
...
bool column_window::update_data(std::vector<float> datalist){
